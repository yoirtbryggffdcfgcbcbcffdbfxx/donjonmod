...
/**
 * Outils generiques pour placer des structures composees multi-cellules.
 */
final class DungeonCompositeRooms {
    ...
    static final Spec TAVERN = Spec.builder()
            ...
            .entry(0, 0)
            .exit(0, 2)
            .label(0, 0, RoomType.TAVERN_1)
            .label(1, 0, RoomType.TAVERN_2)
            .label(1, 1, RoomType.TAVERN_3)
            .label(0, 1, RoomType.TAVERN_4)
            .node(0, 2)
            .edge(0, 0, 1, 0)
            .edge(1, 0, 1, 1)
            .edge(1, 1, 0, 1)
    ...
    static final Spec CAMP = Spec.builder()
            ...
            .entry(0, 0)
            .exit(2, -1)
            .label(0, 0, RoomType.CAMP_1)
            .label(1, 0, RoomType.CAMP_2)
            .label(1, -1, RoomType.CAMP_3)
            .label(0, -1, RoomType.CAMP_4)
            .node(2, -1)
            .edge(0, 0, 1, 0)
            .edge(1, 0, 1, -1)
            .edge(1, -1, 0, -1)
    ...
    static final Spec PRISON_CENTRAL = Spec.builder()
            ...
            .entry(0, 0)
            .exit(0, 1)
            .label(0, 0, RoomType.PRISON_C1)
            .label(1, 0, RoomType.PRISON_C2)
            .label(1, 1, RoomType.PRISON_C3)
            .label(0, 1, RoomType.PRISON_C4)
            .edge(0, 0, 1, 0)
            .edge(1, 0, 1, 1)
            .edge(1, 1, 0, 1)
            .build();
    ...
    static final class Spec {
        ...
        private final Map<LocalPoint, RoomType> labels;
        private final Set<LocalPoint> nodes;
        private final List<LocalEdge> edges;

        private Spec(String name, LocalPoint entry, LocalPoint exit, Map<LocalPoint, RoomType> labels,
    ...
    static final class Builder {
        ...
        private final Map<LocalPoint, RoomType> labels = new LinkedHashMap<>();
        ...
        Builder label(int forward, int side, RoomType label) {
    ...
    static final class Placement {
        ...
        String name() { return spec.name; }

        Point exitPoint() { return worldCells.get(spec.exit); }
        ...
        Map<RoomType, Point> labelPoints() {
            Map<RoomType, Point> out = new LinkedHashMap<>();
